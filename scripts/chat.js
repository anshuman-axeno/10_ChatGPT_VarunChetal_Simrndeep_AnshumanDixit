  ...
  convo.messages.forEach(msg => {
    ...
    if (msg.role === "assistant") {
      ...
      actions.innerHTML = `
        ...
        <button class="action-btn" id="like-btn"><img src="assets/images/thumb-up.svg" class="icon icon-grey"></button>
        <button class="action-btn" id="dislike-btn"><img src="assets/images/thumb-down.svg" class="icon icon-grey"></button>
        <button class="action-btn" id="regen-btn"><img src="assets/images/refresh.svg" class="icon icon-grey"></button>
        <button class="action-btn" id="more-btn"><img src="assets/images/dots.svg" class="icon icon-grey"></button>
      `;
